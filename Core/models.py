...
class Product(models.Model):
    ...
    category = models.ForeignKey(to = Category, on_delete = models.SET_NULL, null = True, blank = True, verbose_name = 'Категория')
    ...
    customer_views = models.ManyToManyField(to = Customer, blank = True)
